...
<template>
    <v-row>
        <v-col align="center">
            <v-btn outlined color="primary" @click="$emit('toggle-thresholds')">Toggle Thresholds</v-btn>
        </v-col>
        <v-col align="center">
            <v-btn outlined color="primary" @click="$emit('download-graph')">Download Graph</v-btn>
        </v-col>
        <v-col align="center">
            <v-btn outlined color="primary" @click="$emit('download-all')">Download All Tables</v-btn>
        </v-col>
        <v-col align="center">
            <v-btn outlined color="primary" @click="$emit('download-pdf')">Download PDF</v-btn>
        </v-col>
    </v-row>
</template>
